...
public class PickUpOrderDto {
	//attribute fields
		 ...
		 * @param timeSlot
		 */
		public PickUpOrderDto(Account account, Integer orderID, Float totalValue, Date date, Time purchaseTime,
		 ...
		 * @param timeSlot
		 */
		public PickUpOrderDto(Account account, Integer orderID, Date date, Time purchaseTime, TimeSlot timeSlot) {
			this.account = account;
			this.orderID = orderID;
			this.date = date;
			this.purchaseTime = purchaseTime;
